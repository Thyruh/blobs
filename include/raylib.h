...
RLAPI char *TextJoin(char **texSIUtList, int count, const char *delimiter);                    // Join text strings with delimiter
...
RLAPI void AudioDevice(void);                                     // Initialize audio device and context
